...
// This class creates a graphical interface for Method D Calculation
public class MethodD6_GUI {

    // This method is called automatically when an object of MethodD6_GUI is created.
    public MethodD6_GUI() {
        // Create the main frame for the GUI
        JFrame frame = new JFrame("Method D Calculation"); 
        ...
        ImageIcon originalIcon = new ImageIcon("MethodD2.png"); 
        // Loading the image file named "MethodD2.png"
        ...
        Image resizedImg = img.getScaledInstance(1247, 450, Image.SCALE_SMOOTH); 
        // Resize the image to 1247 pixels wide and 450 pixels tall, for better quality
        ...
        // Add an action listener to the Back button so it performs an action when clicked
