...
public class MethodD_GUI {

    // This method is called automatically when an object of MethodD_GUI is created.
    public MethodD_GUI() {
        ...
        ImageIcon originalIcon = new ImageIcon("MethodD.png"); 
        // Loading the image file named "MethodD.png"
        ...
        Image resizedImg = img.getScaledInstance(1300, 410, Image.SCALE_SMOOTH); 
        // Resize the image to 1300 pixels wide and 410 pixels tall, for better quality
